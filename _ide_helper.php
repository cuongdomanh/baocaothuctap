 ...
 * Generated for Laravel 5.3.31 on 2017-06-22.
 *
...
namespace Acekyd\LaravelMP3 {
    ...
    class LaravelMP3Facade {
        ...
        {
            return \Acekyd\LaravelMP3\LaravelMP3::load($path);
        }
         ...
         * @static 
         */
        public static function getAlbum($path)
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getAlbum($path);
        }
         ...
         * @static 
         */
        public static function getArtist($path)
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getArtist($path);
        }
         ...
         * @static 
         */
        public static function getBitrate($path)
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getBitrate($path);
        }
        ...
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getDuration($path);
        }
        ...
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getFormat($path);
        }
        ...
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getGenre($path);
        }
        ...
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getMime($path);
        }
        ...
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getTitle($path);
        }
         ...
         * @static 
         */
        public static function getTrackNo($path)
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getTrackNo($path);
        }
         ...
         * @static 
         */
        public static function getYear($path)
        {
            return \Acekyd\LaravelMP3\LaravelMP3::getYear($path);
        }
         ...
         * @static 
         */
        public static function isLossless($path)
        {
            return \Acekyd\LaravelMP3\LaravelMP3::isLossless($path);
        }
...
namespace {
    ...
    class Menu extends \App\Helpers\Menu {}
    
    class Module extends \App\Helpers\Module {}
    
    class LaravelMP3 extends \Acekyd\LaravelMP3\LaravelMP3Facade {}
