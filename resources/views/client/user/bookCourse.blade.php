    ...
    <div class="container">
        ...
        <section class="col-sm-9 ">
            <div class="user_C">
                ...
                <hr>
                {{Form::open(['method'=>'post','url'=>'acount/bookCourse'])}}
                <div class="form-group">
                    <label for="usr">Mã theo sách </label>
                    <input type="text" class="form-control" id="usr" name="encode">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="input-icon">
                            <input type="text" class="form-control" id="msg" name="keyBookCourse"
