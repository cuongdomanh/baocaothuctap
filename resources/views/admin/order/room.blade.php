...
@section('breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ url('admin/order/room') }}">Thanh toán</a><i class="fa fa-circle"></i>
        </li>
        <li><a href="{{ url('admin/order/room')}}">Phòng thi</a></li>
    </ul>
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['method' => 'GET', 'url' => 'admin/order/room']) !!}
            ...
            <select name="" id=""  class="form-control" style="width:130px;float: right ;margin-top: -32px;" onchange="location = this.value;">
                ...
                <option value="admin/order/batch">Luyện đề</option>
