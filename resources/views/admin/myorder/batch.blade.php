...
@section('breadcrumb')
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="{{ url('admin/order/batch') }}">Thanh toán</a><i class="fa fa-circle"></i>
        </li>
        <li><a href="{{ url('admin/order/batch')}}">Tệp</a></li>
    </ul>
@endsection
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::open(['method' => 'GET', 'url' => 'admin/order/batch']) !!}
